export default function EMLayout({
  ...
  return (
    <div className="em">
      {/* top label centered */}
      <div className="row-start-2 col-start-4 self-center">
      ...
      <article data-id="right-block" className="row-start-4 col-start-4 self-center max-w-[var(--right)] grid gap-[10px]">
