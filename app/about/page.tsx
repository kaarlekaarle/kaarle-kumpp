...
export default function About() {
  return (
    <main className="container min-h-[70vh] grid md:grid-cols-2 gap-10 md:gap-24 mt-12 md:mt-16">
      <div>
        <h1 className="text-2xl font-normal uppercase tracking-wide mb-2" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>{about.name}</h1>
      ...
      <article className="max-w-prose">
        <h2 className="text-xl font-normal uppercase tracking-wide mb-6" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>{about.tagline}</h2>
