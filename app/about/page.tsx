...
export default function AboutPage() {
  const portraitSrc = "/images/portrait.jpg"; // or .svg if that is the existing file

  return (
    <main className="min-h-screen bg-paper text-ink">
      {/* rows: M | top | M | right | M | bottom | M
         cols: left | M | right | M   (no left outer M) */}
      <div
        className="
          min-h-screen grid
        ...
        "
      >
        {/* TOP LABEL (24px black) aligned to right column */}
        <div className="row-start-2 col-start-3 self-start">
          <p data-id="top" className="uppercase tracking-wide font-normal text-[24px]">
            Kaarle & Kumpp.
          </p>
        </div>
        ...
        <article className="row-start-4 col-start-3 self-start max-w-[var(--kk-right-col)]" data-id="right-block">
          <h1 className="uppercase tracking-wide font-normal text-[24px] text-ink">About</h1>
