...
export default function Page() {
  return (
    <main className="min-h-screen bg-paper text-ink">
      <div className="mx-auto max-w-[1280px] px-6 md:px-8 pt-24 md:pt-28 pb-24 md:pb-32">
        <div
          className="
            grid
            grid-cols-[minmax(0,1fr)_var(--col-left)_var(--col-gap)_var(--col-right)_minmax(0,1fr)]
            gap-x-0
            grid-rows-[auto_minmax(0,1fr)_auto]
          "
        >
          {/* Row 1: WORKS label aligned to RIGHT column left edge */}
          <div className="row-start-1 col-start-4">
            <Link href="/works" className="uppercase tracking-wide text-[15px] font-sans hover:text-accent transition-colors">
              Works
            </Link>
          </div>
          ...
          <div className="row-start-2 col-start-2 self-center">
            <div className="text-center leading-tight">
              <div className="uppercase tracking-wide text-[48px] font-sans">KAARLE</div>
              ...
              <div className="uppercase tracking-wide text-[48px] font-sans">KUMPP.</div>
            </div>
          </div>

          {/* Row 2: RIGHT text block (exact same left edge as WORKS/ABOUT) */}
          <article className="row-start-2 col-start-4 self-center max-w-[var(--col-right)]">
            <h1 className="uppercase tracking-wide text-accent text-[22px] font-normal font-sans">
              Problem solving and storytelling.
            </h1>
            <div className="mt-5 space-y-3 leading-[1.55] text-[15px] text-accent" style={{fontFamily: "'Garamond Premier', 'Times New Roman', serif"}}>
            ...
            <p className="mt-4 uppercase font-semibold text-accent text-[15px] font-sans">
              What is your problem?
            </p>
          </article>

          {/* Row 3: contact centered under logo column */}
          <div className="row-start-3 col-start-2 mt-12 flex justify-center">
          ...
          {/* Row 3: ABOUT aligned to RIGHT column left edge */}
          <div className="row-start-3 col-start-4 mt-12">
            <Link href="/about" className="uppercase tracking-wide text-[15px] font-sans hover:text-accent transition-colors">
              About
            </Link>
          </div>
        </div>
