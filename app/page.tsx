  ...
  return (
    <main className="min-h-screen bg-paper text-ink">
      ...
      >
        ...
        <div className="row-start-1 col-start-4 self-end">
        ...
        <article className="row-start-2 col-start-4 self-center max-w-[var(--kk-right)]">
          <h1 className="uppercase tracking-wide font-normal text-accent font-sans" style={{ fontSize: "var(--kk-size-right)" }}>
          ...
          <p className="mt-4 uppercase font-normal text-accent font-sans" style={{ fontSize: "var(--kk-size-right)" }}>
            What is your problem?
          </p>
        </article>

        {/* Row 3: Contact centered under logo; ABOUT centered on row; both same baseline center */}
        <div className="row-start-3 col-start-2 self-start flex justify-center items-center">
        ...
        <div className="row-start-3 col-start-4 self-start flex items-center">
