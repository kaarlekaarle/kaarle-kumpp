      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex justify-between items-center">
            <Link href="/" className="text-lg sm:text-xl font-bold uppercase tracking-wider" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>
              KAARLE ✳ KUMPP.
            </Link>
            <Link href="/works" className="text-xs sm:text-sm font-medium uppercase tracking-wide hover:text-accent transition-colors" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>
              WORKS
            </Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative animate-fade-in">
                ...
                {/* Decorative Element */}
                <div className="w-16 h-1 bg-accent mb-8 animate-slide-up"></div>
            ...
            <div className="order-1 lg:order-2">
              <div className="prose prose-lg max-w-none animate-slide-up" style={{fontFamily: "'Garamond Premier', 'Times New Roman', serif"}}>
