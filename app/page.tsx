      ...
      <div className="flex h-screen">
        ...
        <div className="w-1/2 flex items-center justify-center p-12">
          <div className="max-w-lg">
            {/* Main Heading */}
            <h1 className="text-4xl font-bold uppercase leading-tight text-accent mb-8" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>
            ...
            {/* Key Question */}
            <div className="text-3xl font-bold uppercase text-accent mt-8" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>
