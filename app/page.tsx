  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex h-screen">
        ...
        <div className="w-1/2 flex items-center justify-center p-12">
          <div className="max-w-lg">
            ...
            {/* Content Text - All in Blue */}
            <div className="space-y-6 text-accent leading-relaxed" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>
              <p className="text-lg">
      ...
      <div className="absolute bottom-6 left-6 right-6 flex justify-between items-center">
        {/* Contact Info */}
        <div className="text-sm font-medium text-gray-900" style={{fontFamily: "'Kaarle & Kumppanit', Arial, sans-serif"}}>
